                ...
                if (!accountSwitcher) {
                    ...
                    for (MaterialAccount account : accountManager) {
                        ...
                        if(account.getAccountNumber() != MaterialAccount.FIRST_ACCOUNT) {
                            ...
                            sections.addView(account.getSectionView(MaterialNavigationDrawerCosmm.this, fontManager.getRobotoMedium(),accountSectionListener,rippleSupport,account.getAccountNumber()),params);
                        }
                    }
                    ...
                    for(Element element : elementsList) {
                        switch(element.getType()) {
                            ...
                            case Element.TYPE_DIVISOR:
                                View view = new View(MaterialNavigationDrawerCosmm.this);
                    ...
                    View divisor = new View(MaterialNavigationDrawerCosmm.this);
                    divisor.setBackgroundColor(Color.parseColor("#8f8f8f"));

                    // si aggiungono le bottom sections
                    if (heightDrawer >= Utils.getScreenHeight(MaterialNavigationDrawerCosmm.this)) {
